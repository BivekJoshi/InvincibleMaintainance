...
GIT
- Work on a local branch `admin/phase-h1-operations-admin` created from DEVELOPMENT.
...
- Before starting, check that Phase G's work is present on DEVELOPMENT (its files and migrations
