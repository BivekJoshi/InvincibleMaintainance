...
GIT
- Work on a local branch `admin/phase-d2-content-settings` created from `prabesh`.
...
- Before starting, check that Phase D1's work is present on `prabesh` (its files and migrations
