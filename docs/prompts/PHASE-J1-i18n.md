...
GIT
- Work on a local branch `admin/phase-j1-i18n` created from DEVELOPMENT.
...
- Before starting, check that Phase I's work is present on DEVELOPMENT (its files and migrations
