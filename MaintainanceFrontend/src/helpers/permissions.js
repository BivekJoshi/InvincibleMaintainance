...
export const PERMISSIONS = {
  ...
  DISPATCHER: ['jobs:read', 'jobs:write', 'jobs:dispatch', 'jobs:history', 'technicians:read', 'technicians:write', 'materials:read', 'materials:write', 'customers:read', 'leads:read', 'surveys:read', 'services:read', 'media:read', 'media:write', 'dashboard:read', 'reports:ops'],
  ...
  ACCOUNTANT: ['invoices:read', 'invoices:write', 'invoices:history', 'payments:read', 'payments:write', 'expenses:read', 'expenses:write', 'customers:read', 'jobs:read', 'quotations:read', 'dashboard:read', 'reports:finance'],
};
